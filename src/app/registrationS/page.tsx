...
const Image: React.FC<ImageProps> = ({ src, alt, className }) => ( // this is the image attributes
  <img loading="lazy" src={src} alt={alt} className={className} />
);

const Nav: React.FC<NavProps> = ({ items }) => ( // this is the navigation bar attributes
...
const FormField: React.FC<FormFieldProps> = ({ label, id, type }) => ( // this is the form field attributes
...
const MemberForm: React.FC<MemberFormProps> = () => ( // this is the member form attributes
...
const MyComponent = () => { // this is the main component, where all the attributes are being called. like main
  ...
  return (
    <div className="flex flex-col pt-3 bg-white">
      ...
      <main className="mt-12 w-full max-w-[1627px] max-md:mt-10 max-md:max-w-full">
        <section className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <aside className="flex flex-col mt-20 ml-5 w-[41%] max-md:ml-0 max-md:w-full">
            ...
            />
            <blockquote className="mx-6 mt-14 text-3xl font-bold text-amber-600 max-md:mx-2.5 max-md:mt-10">
      ...
      <section className="mt-80 text-4xl font-bold px-12 ml-20 text-amber-600 max-md:mt-10">
